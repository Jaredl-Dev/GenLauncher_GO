...
internal sealed class StubLauncherFilePicker : ILauncherFilePicker
{
    ...
    public string? ManualContentFolderResult { get; init; }
    ...
    public Task<string?> PickManualContentFolderAsync(Window owner)
    {
        return Task.FromResult(ManualContentFolderResult);
    }

...
{
    [Fact]
    public void ClearDirectoryCreatesStagingFolderAndDeletesExistingChildren()
    {
    ...
    [Fact]
    public void DeleteEmptyPackageParentsRemovesEmptyChainThroughPackagesFolder()
    {
        using TestDirectory testDirectory = new();
        string stagingFolder = Path.Combine(testDirectory.Path, "Packages", "Mod", "1.0");
    ...
    [Fact]
    public void DeleteEmptyPackageParentsStopsWhenParentContainsOtherEntries()
    {
        using TestDirectory testDirectory = new();
        string stagingFolder = Path.Combine(testDirectory.Path, "Packages", "Mod", "1.0");
        string packageFolder = Path.GetDirectoryName(stagingFolder)!;
    ...
    [Fact]
    public void DeleteEmptyPackageParentsReturnsWhenPathIsNotUnderPackagesFolder()
    {
        using TestDirectory testDirectory = new();
    ...
    [Fact]
    public void DeleteEmptyPackageParentsReturnsWhenPackagesAncestorDoesNotExist()
    {
        using TestDirectory testDirectory = new();
        string stagingFolder = Path.Combine(testDirectory.Path, "Packages", "Mod", "1.0");
    ...
    [Fact]
    public void RemoveUnsafeLinksHonorsPreCanceledToken()
    {
        using TestDirectory testDirectory = new();
        string stagingFolder = Path.Combine(testDirectory.Path, "Packages", "Mod", "1.0");
    ...
    [Fact]
    public void PruneToManifestDeletesStaleFilesAndKeepsConvertedBigFiles()
    {
        using TestDirectory testDirectory = new();
        string stagingFolder = Path.Combine(testDirectory.Path, "Packages", "Mod", "1.0");
        string nestedFolder = Path.Combine(stagingFolder, "Data");

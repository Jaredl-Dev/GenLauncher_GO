...
public sealed class DeploymentPathResolverTests
{
    ...
    [InlineData(@"Data//INI\\GameData.ini", "Data/INI/GameData.ini")]
    [InlineData(" Data/INI/GameData.ini ", " Data/INI/GameData.ini ")]
    public void NormalizeManifestPath_NormalizesSeparators(string relativePath, string expectedPath)
    {
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void NormalizeManifestPath_RejectsMissingPaths(string relativePath)
    {
    ...
    [InlineData("./Data/GameData.ini", "Deployment manifest paths must not contain parent directory segments.")]
    public void NormalizeManifestPath_RejectsUnsafePaths(string relativePath, string expectedMessage)
    {
        Action act = () => DeploymentPathResolver.NormalizeManifestPath(relativePath);
    ...
    [Fact]
    public void ResolveGamePath_ReturnsPathInsideGameDirectory()
    {
    ...
    [Fact]
    public void ResolveGamePath_RejectsLauncherOwnedPaths()
    {
        using TestDirectory directory = new();
    ...
    [Fact]
    public void ToRelativeManifestPath_ReturnsNormalizedChildPath()
    {
        using TestDirectory directory = new();
    ...
    [Fact]
    public void ToRelativeManifestPath_RejectsPathsOutsideRoot()
    {
        using TestDirectory directory = new();
        string rootDirectory = Path.Combine(directory.Path, "Package");
    ...
    [Fact]
    public void ResolveDeploymentStatePath_RejectsPathsOutsideDeploymentDirectory()
    {
        using TestDirectory directory = new();
        string deploymentDirectory = Path.Combine(directory.Path, "Deployment");

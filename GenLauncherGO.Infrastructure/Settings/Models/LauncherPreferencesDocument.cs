...
{
    /// <summary>
    ///     Tracks whether YAML binding encountered the schema key. The load fallback explicitly assigns
    ///     <see langword="null" />,
...
internal sealed class LauncherSharedPreferencesDocument
{
    ...
    public bool HasShownRetailGenPatcherRecommendation { get; set; }
}
...
internal sealed class LauncherGamePreferencesDocument
{
    ...
    public double ModsListVerticalOffset { get; set; }

    public int AdvertisingPositionInList { get; set; }

...
internal static class LauncherPreferencesDocumentMapper
{
    ...
    private static IReadOnlySet<string> GetBuiltInGameClientNames(SupportedGame game)
    {
        var names = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            LauncherFileSystemLayout.GetCommunityGameExecutableName(game),
        };
    ...
    private static IReadOnlySet<string> GetBuiltInWorldBuilderNames(SupportedGame game)
    {
        return new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            LauncherFileSystemLayout.VanillaWorldBuilderExecutableFileName,
            LauncherFileSystemLayout.GetCommunityWorldBuilderExecutableName(game),
        };
    }

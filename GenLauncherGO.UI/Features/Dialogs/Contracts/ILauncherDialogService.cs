...
internal interface ILauncherDialogService
{
    ...
    /// <summary>
    ///     Shows a themed information dialog with an additional action.
    /// </summary>
    /// <returns><see langword="true" /> when the user chose the additional action.</returns>
    Task<bool> ShowInfoActionAsync(

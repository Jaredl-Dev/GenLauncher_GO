...
/// </remarks>
internal sealed record LauncherStoragePaths
{
    private const string PreferencesFileName = "LauncherPreferences.yaml";

    private const string ApplicationUpdateCheckTimestampFileName = "LastApplicationUpdateCheckUtc.txt";
    ...
    /// <summary>
    ///     Gets the invariant UTC timestamp used to throttle automatic application-update checks.
    /// </summary>
    public string ApplicationUpdateCheckTimestampFilePath =>
        Path.Combine(DataDirectory, ApplicationUpdateCheckTimestampFileName);

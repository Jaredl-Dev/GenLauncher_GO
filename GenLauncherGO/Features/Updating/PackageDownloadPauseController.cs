...
/// </summary>
internal sealed class PackageDownloadPauseController
{
    ...
    /// <summary>
    ///     Waits at a cooperative pause checkpoint when a controller was supplied.
    /// </summary>
    public static ValueTask WaitWhilePausedAsync(
        PackageDownloadPauseController? controller,
        CancellationToken cancellationToken)
    {
        return controller?.WaitWhilePausedAsync(cancellationToken) ?? ValueTask.CompletedTask;
    }
}

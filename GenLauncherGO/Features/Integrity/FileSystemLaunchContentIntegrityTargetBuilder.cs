...
/// </summary>
internal sealed class FileSystemLaunchContentIntegrityTargetBuilder
{
        ...
        LauncherContentVersion version)
    {
        ...
        return new ContentIntegrityTarget(
            ContentIntegrityTargetId.ForPackage(version.ContentKey),
            version.DisplayName,
            packageDirectory,
    ...
    private ContentIntegrityTarget CreateCacheTarget(
        ...
        LauncherContentVersion version)
    {
        string cacheDirectory = ModificationImageCachePath.ResolveDirectory(
            request.Paths,
        ...
        return new ContentIntegrityTarget(
            ContentIntegrityTargetId.ForCache(version.ContentKey),
        ...
        string cacheDirectory)
    {
        ...
        var ignoredBaseNames = request.AllVersions
            ...
            .SelectMany(ModificationImageCachePath.GetOwnedBaseNames)

...
internal sealed class LauncherGameSessionCoordinator
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await _catalog.InitDataAsync(
                CreateRemoteManifestUri(connected, _runtimeContext.ModsRepositoryUrl),
                newPaths,
                cancellationToken);
        ...
        bool oldConnected)
    {
        ...
        {
            await _catalog.InitDataAsync(
                CreateRemoteManifestUri(oldConnected, oldRepositoryUrl),
                oldPaths,
    ...
    private static Uri? CreateRemoteManifestUri(
        bool connected,
        string? repositoryUrl)
    {
        return connected && !string.IsNullOrWhiteSpace(repositoryUrl)

...
/// </remarks>
internal readonly struct LauncherContentKey : IEquatable<LauncherContentKey>
{
    ...
    [AllowNull]
    public string ParentIdentity => field ?? string.Empty;

    [AllowNull]
    public string Name => field ?? string.Empty;

    [AllowNull]
    public string Version => field ?? string.Empty;

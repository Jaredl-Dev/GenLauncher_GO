...
internal sealed class LauncherLocalContentReconciler
{
    ...
    public IReadOnlyList<LauncherContentKey> DiscardContent(
        LauncherData launcherData,
        LauncherContentKey contentKey,
        LauncherPaths paths)
    {
        ...
        IReadOnlyList<LauncherContentKey> dependentKeys = launcherData.GetDependentContentKeys(contentKey);
        foreach (LauncherContentKey dependentKey in dependentKeys)
        {
            _localContentService.DeleteContent(paths, dependentKey);
        }
        ...
        foreach (LauncherContentKey dependentKey in dependentKeys)
        {
            _localContentService.DeleteImagesIfUnused(paths, dependentKey, launcherData);
        }

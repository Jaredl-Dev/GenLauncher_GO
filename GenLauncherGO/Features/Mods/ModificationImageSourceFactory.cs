...
{
    private const string DefaultImageResourceNamePrefix = "GenLauncherGO.Features.Mods.Resources.";
    ...
    {
        string resourceName = DefaultImageResourceNamePrefix + PerGame.Select(
            supportedGame,

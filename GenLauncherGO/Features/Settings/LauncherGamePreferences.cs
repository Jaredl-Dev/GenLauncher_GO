...
internal sealed record LauncherGamePreferences
{
    ...
    /// <summary>
    ///     Gets the selected executable registration for one launch target.
    /// </summary>
    ...
    /// <summary>
    ///     Replaces the selected executable registration for one launch target.
    /// </summary>
        ...
        string executablePath)
    {
        ...
        return targetKind switch
        {
            GameLaunchTargetKind.GameClient => this with { SelectedGameClient = executablePath },
            GameLaunchTargetKind.WorldBuilder => this with { SelectedWorldBuilder = executablePath },
            _ => throw new ArgumentOutOfRangeException(nameof(targetKind), targetKind, "Unknown launch target.")
        };
    }
}

...
/// </summary>
internal static class LauncherGameArgumentService
{
    /// <summary>
    ...
    /// <summary>
    ///     The Generals Online launcher override that prevents it from adding windowed mode.
    /// </summary>
    public const string GeneralsOnlineFullscreenArgument = "-fullscreen";

    /// <summary>
    ///     The Generals Online game argument that disables its community data patch for the current launch.
    /// </summary>
    public const string GeneralsOnlineDisableCommunityDataPatchArgument = "-disableCommunityDataPatch";
